package chap98homework.nc230321;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

import chap98homework.nc230321.employee.ContractEmployee;
import chap98homework.nc230321.employee.Employee;
import chap98homework.nc230321.employee.RegularEmployee;
import chap98homework.nc230321.employee.TempEmployee;
			...
			while(true) {
				...
				switch(input) {
					...
					case 3 : 
						...
						workDay = sc.nextInt();
						//ep[eno] = new ContractEmployee(eno, name, pay, workDay);
						ep[eno].showEmployeeInfo();
						System.out.println("----------------");
						break;
					case 4 : 
